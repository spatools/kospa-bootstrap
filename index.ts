...
export function start(options: StartOptions, ...handlersOrModules: (string | InitializeModule | InitializeHandler | PromiseLike<any>)[]): Promise<Node> {
...
function initModule(mod: InitializeModule): PromiseLike<any> {
